...
export default () => {
  ...
  return (
    <nav className="bg-bot-alpha max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto px-6 md:px-10 lg:px-16 xl:px-20 py-4 border-b border-b-[#503569]">
